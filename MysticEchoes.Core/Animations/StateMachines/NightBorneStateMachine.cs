...
public class NightBorneStateMachine : BaseStateMachine
{
    ...
    public NightBorneStateMachine(int ownerEntityId, EcsWorld world) : base(ownerEntityId, world)
    {
    ...
    public override void Update()
    {
        ...
        if (characterAnimationComponent.Animations.TryGetValue(currentState, out var animation) && _animations.Has(OwnerEntityId))
        {
            ...
            animationComponent.ReflectByY = RunIsLeft();
